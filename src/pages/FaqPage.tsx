...
export function FaqPage(): JSX.Element {
  return (
    <>
      <PageHero eyebrow="Useful answers" title="Frequently Asked Questions" summary="Straightforward information about laboratory services, case submission, review, delivery and pricing." />
